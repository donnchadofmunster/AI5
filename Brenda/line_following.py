...
from CNNmodel import LineFollower  # Import the CNN model
import torch
        ...
        if probe.connected:
            ...
            if newHIL:
                ...
                if newDownCam:
                    ...
                    binary = vision.subselect_and_threshold(gray_sm, 50, 100, 127, 255)
                    ...
                    forSpd, turnSpd = line2SpdMap.send((prediction))
                    # #---------------------------------------------------------#
                    
                    # line_center = vision.detect_centerline(gray_sm)
                    # line_angle = vision.detect_angle(line_center)
